    ...
    <div class="foot_base">
        <div class="foot_main">
            ...
            <div class="footer">
                ...
                <div class="footer_font_content content_div">
                    <el-row>
                        Community
                    </el-row>
    ...
    export default {
        ...
        data(){
            return{
                ...
                twitterIcon: require("@/img/icon/twitter_icon.png"),
                playIcon: require("@/img/icon/play_icon.png"),
                flyIcon: require("@/img/icon/fly_icon.png"),
